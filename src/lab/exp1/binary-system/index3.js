...
function addition(firstValue,secondValue) {
  ...
  if(x.length < y.length)	{
	  ...
	  document.getElementById('addResult').value = z1;
    //alert(z1); // print it out
	}
}
...
function addition1(res) {
  x = res[0];
	...
	z2 = add(z2,y);
	document.getElementById('mulResult').value = z2;//alert(z2);
}
...
function add( a,  b) {
  ...
  //iterates the a string until it becomes zero
